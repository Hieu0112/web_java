    ...
    <div class="grid wide">
        <div class="row footer--content">
            <div class="col l-3 m-4 c-12">
                ...
                <ul class="footer-list">
                    ...
                    <li class="footer-item">
                        Điện thoại:
                        <a href="tel:+84  0988289071" class="footer-item__link footer-item__link--Contact"
                           >0988289071</a
                        >
                    </li>
                    <li class="footer-item">
            ...
            <div class="col l-3 m-4 c-12">
                ...
                <ul class="footer-list">
                    <li class="footer-item">
                        Điện thoại: <a href="tel:+84  0910201900" class="footer-item__link">0988289071</a>
                    </li>
                    <li class="footer-item">
                        Gmail:
                        <a href="mailto:shopptit@gmail.com" class="footer-item__link">ltw0308@gmail.com</a>
                    </li>
                    <li class="footer-item">
                        <a href="" class="footer-item__link">Hướng dẫn mua hàng</a>
                    </li>
